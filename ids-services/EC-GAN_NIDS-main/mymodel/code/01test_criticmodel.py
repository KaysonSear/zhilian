...
# 加载数据
data = pd.read_csv("../data/clean3.csv", encoding="GBK")
print(data.head())
...
classifier_gan_model = keras.models.load_model('../models/50_classifier_ecgan.h5')
...
predictions2 = classifier_gan_model.predict(x)
print(predictions)
print("+++++++++++++++++++++++")
print(predictions2)
# 获取预测的类别索引
