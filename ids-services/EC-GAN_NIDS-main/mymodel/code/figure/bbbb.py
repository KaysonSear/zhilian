...
plt.subplot(2, 2, 1)
plt.plot(epochs, d_losses, label='D loss', color=palette[0])
...
plt.subplot(2, 2, 2)
plt.plot(epochs, g_losses, label='G loss', color=palette[1])
...
plt.subplot(2, 2, 3)
plt.plot(epochs, c_losses, label='C loss', color=palette[2])
...
plt.subplot(2, 2, 4)
plt.plot(epochs, c_accs, label='C acc', color=palette[3])
