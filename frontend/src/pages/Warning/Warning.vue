  ...
  <div class="container">
    <div class="TopArea">
      <div class="left">
        ...
        <dv-border-box-13>
          <div class="topTitle" style="font-size: 18px; top: 10%;">安全策略提醒</div>
          <div class="report">
            在此次流量分析中，我们发现服务器存在多种类型的攻击行为。通过使用<span style="text-decoration: underline; font-style: italic;color:#46a5f5;">TransEC-GAN</span>模型，成功识别了多种攻击。
            <div class="Btn">
<!--              <button @click="openModal">查看报告</button>-->
              <button @click="">威胁溯源</button>
            </div>
          </div>
        </dv-border-box-13>
      </div>
